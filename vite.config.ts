...
const localBindingConfig = {
  ...
  d1_databases: d1 ? [{ binding: d1, database_name: "terry-ai-lab-d1", database_id: "00000000-0000-4000-8000-000000000000" }] : [],
  r2_buckets: r2 ? [{ binding: r2, bucket_name: "terry-ai-lab-r2" }] : [],
};
